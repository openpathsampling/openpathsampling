...
simulation.reporters.forward(StateDataReporter('data/nvtInfo.dat', 100, step=True, potentialEnergy=True, temperature=True, separator=' '))
#simulation.reporters.forward(PDBReporter('nvt.pdb', 50)) #write out every 50 steps to a pdb file
