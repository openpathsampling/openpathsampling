...
def parse_options():
    ...
    parser.add_option('-p', '--local-port', action='store', type='int',
                      dest='port',
    ...
    parser.add_option('', '--no-key', action='store_false',
                      dest='look_for_keys', default=True,
    ...
    parser.add_option('-r', '--remote', action='store', type='string',
                      dest='remote', default=None, metavar='host:port',
