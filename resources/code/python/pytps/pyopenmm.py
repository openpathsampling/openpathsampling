...
>>> import simtk.chem.openmm.extras.testsystems as testsystems # some test systems to play with
...
>>> import simtk.chem.openmm.extras.amber as amber # for reading AMBER files
>>> import os.path
...
class System(object):
    ...
    def __init__(self, system=None, debug=True):
        """
        Create a new System.
        ...
        self.debug = debug # display debugging and timing information
    ...
    def _copyDataUsingInterface(self, dest, src):
        ...
        final_time = time.time() # DEBUG
        if self.debug: print "_copyDataUsingInterface took %.3f s" % (final_time - initial_time) # DEBUG
...
class CustomNonbondedForce(Force):
    ...
    def __init__(self, energy=None, parameter_units=None, force=None):
        ...
        # Populate data structures from swig object, if specified
            ...
            self.energyExpression = force.getEnergyFunction()
