...
volume according to the rules of the LambdaVolume._lrange_to_Volume
function:
...
------------------------+--------------------------------------------------
                    ...
                    -1  | `FullVolume`
                  None  | `EmptyVolume`
 list with one 2-tuple  | `LambdaVolume` with range given by 2-tuple
list with two 2-tuples  | `VolumeCombination` of or'd together 
                        | `LambdaVolume`s with ranges given by the 2-tuples
------------------------+--------------------------------------------------
