...
class Sample(object):
    """
    A Move is the return object from a PathMover and contains all
    information about the move, initial trajectories, new trajectories (both
    as references). Might move several trajectories at a time (swapping)

    Notes
    -----
    Should contain inputs/outputs and success (accepted/rejected) as well as
