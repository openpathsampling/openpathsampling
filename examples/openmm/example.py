...
simulation2.reporters.forward(PDBReporter('output_exercise1.pdb', 5)) 
simulation2.reporters.forward(StateDataReporter(stdout, 100, step=True, potentialEnergy=True, temperature=True))
