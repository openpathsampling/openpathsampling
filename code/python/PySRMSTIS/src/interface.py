...
class TISInterface(object):
    def __init__(self):
        iface_set = -1
        allowed_initial_state = [ 1 ]
        allowed_final_state = [ 1, 2 ]
        lambda_j = 0.0
...
class MultiStateInterface(TISInterface_D):
...
class MultipleSetMinusInterface(TISInterface_D):
    def __init__(self):
        pass
