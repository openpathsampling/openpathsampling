...
def write_version_py(filename='opentis/version.py'):
    cnt = """
...
def buildKeywordDictionary():
    ...
    setupKeywords["packages"]          = ['opentis', 'opentis.storage']
    setupKeywords["package_dir"]       = {'opentis' : 'opentis', 'opentis.storage' : 'opentis/storage'}
    ...
    Opentis (http://github.com/choderalab/opentis) is a python library to do transition interface sampling.
    """
    outputString=""
    firstTab     = 40
    secondTab    = 60
